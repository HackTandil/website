...
export function SurveillanceHero() {
	...
	// 5. brackets re-form as floating nav markers
	const navIn = mapRange(progress, 0.72, 0.9);
		...
		<section ref={sectionRef} className="relative h-[420vh]">
			<div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden bg-black">
				...
				>
					...
					{/* floating nav markers — brackets re-form here */}
					<FloatingNav opacity={navIn} />

					{/* hero copy */}
					<div
						className="pointer-events-none absolute inset-0 z-20 flex flex-col items-center justify-center px-6 text-center"
						style={{
							opacity: heroIn * (1 - navIn * 0.15),
